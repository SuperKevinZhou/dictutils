...
fn create_example_dictionary(path: &Path) -> dictutils::Result<()> {
    ...
    let entries = vec![
        ...
        ("dictionary", "A reference work that lists words and gives their meanings."),
        ("rust", "A reddish-brown metal; also a programming language."),
        ("example", "A thing characteristic of its kind or illustrating a general rule."),
        ("loading", "The process of putting something into or onto a vehicle or container."),
    ];
